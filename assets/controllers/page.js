$(function(){
	...
	if (pathname.indexOf('add') > -1 || pathname.indexOf('edit') > -1) {
		...
		$('#datetimepicker-page').datetimepicker({
...
function wysihtml5ImagePicker() {
	...
	// 1. Upload
	var uploadUrl = project + "/page/uploadPicture";
	...
	$('#gallery-image').click(function(){
		...
		if (open == true) {
			...
			$.getJSON(project + '/page/getImage', function(result) {
		        ...
		        if (result.status == true) {
		        	...
		        	if (result.remaining > 0) {
		        		var more = '<div id="more-featured-gallery" data-url="' + project + '/page/getImage/' + result.start + '" class="col-lg-12 more-center"><button class="btn btn-info btn-sm">Load More</button></div>';
