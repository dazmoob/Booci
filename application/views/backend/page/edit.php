<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
	...
	<div class="row">
		...
		<div class="col-md-2 col-lg-2 col-sm-4 col-xs-12">
			<a href="<?php echo site_url('page/all'); ?>" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-list-alt"></i>&nbsp; Page List</a>

			<?php $this->load->view('backend/page/sidebar'); ?>

		</div><!-- /.col -->

		<form method="POST" action="<?php echo site_url('page/update/'.set_value('slug')); ?>">
			...
			<div class="col-md-7 col-lg-7 col-sm-8 col-xs-12">
				<div class="box box-primary">
					...
					<div class="box-header with-border">
						...
						<h3 class="box-title"> Compose New Page</h3>
					</div><!-- /.box-header -->
			...
			<div class="col-md-3 col-lg-3 col-sm-12 col-xs-12">
				...
				<?php $this->load->view('backend/page/widget'); ?>
